...
class IndividualQuestionSchema {
    ...
    factory IndividualQuestionSchema.fromJson(Map<String, dynamic> json) => IndividualQuestionSchema(
        name: json["name"],
        label: json["label"],
        hidden: json["hidden"],
        readonly: json["readonly"],
        options: json["options"] == null ? [] : List<Option>.from(json["options"]!.map((x) => Option.fromJson(x))),
        fields: json["fields"] == null ? [] : List<SubField>.from(json["fields"]!.map((x) => SubField.fromJson(x))),
    );
